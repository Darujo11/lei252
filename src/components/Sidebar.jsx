import { Home, BookOpen, Calculator, FileText, BarChart3, Shield, ChevronDown, ChevronRight } from 'lucide-react'
      ...
      <nav className="p-4">
        ...
        <div className="mb-4">
          ...
          <button
            ...
            className={`sidebar-item w-full text-left px-4 py-2.5 text-sm flex items-center gap-3 ${activeSection === 'privacidade' ? 'active bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50'}`}
          >
            <Shield size={16} />
            Privacidade
          </button>
